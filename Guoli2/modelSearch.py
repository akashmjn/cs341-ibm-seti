...
for i in range(20):
    ...
    print "\n\n ##### Running a new run with ###### "
    print '{} {} {} {} {} {} {:.2e} {:.2f} {:.2f} {}\n'.format(datasetPath,run_name,augmentFactor,nEpochs,epoch_offset,optim,lr,lrAnneal,dropout,kernel_init)
    os.system('python cnnModelTrain.py {} {} {} {} {} {} {} {} {} {} {}'.format(datasetPath,run_name,augmentFactor,nEpochs,epoch_offset,optim,lr,decay,dropout,lrAnneal,kernel_init))
